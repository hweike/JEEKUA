...
export function FullwidthSlider({ height, autoplay, images, puck, __runtime }: any) {
  ...
  return (
    <div ref={puck?.dragRef} style={fullWidthStyle} className="relative">
      <div
