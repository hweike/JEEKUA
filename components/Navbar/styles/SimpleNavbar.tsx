...
export default function SimpleNavbar({ headerConfig, menuTree, siteSettings }: NavbarClientProps) {
  ...
  return (
    <nav
      ...
      style={{
        ...
        transition: `box-shadow var(--transition-duration-300, 300ms) var(--transition-timing-ease, ease)`,
      } as React.CSSProperties}
    >
      {/* 滑动容器：整体滑动，包含公告栏和所有导航内容 */}
      <div
        className={cn(
